...
let ``CompletionAssessmentManager - 基本的なタスク完成度評価テスト`` () =
    ...
    let tasks = [
        { TaskId = "task1"; Title = "Task 1"; Description = ""; Status = TaskStatus.Completed; AssignedAgent = None; Priority = TaskPriority.High; EstimatedDuration = None; ActualDuration = None; RequiredResources = []; CreatedAt = now; UpdatedAt = now }
        { TaskId = "task2"; Title = "Task 2"; Description = ""; Status = TaskStatus.InProgress; AssignedAgent = None; Priority = TaskPriority.Medium; EstimatedDuration = None; ActualDuration = None; RequiredResources = []; CreatedAt = now; UpdatedAt = now }
        { TaskId = "task3"; Title = "Task 3"; Description = ""; Status = TaskStatus.Failed; AssignedAgent = None; Priority = TaskPriority.Low; EstimatedDuration = None; ActualDuration = None; RequiredResources = []; CreatedAt = now; UpdatedAt = now }
    ]
...
let ``CompletionAssessmentManager - 高品質完成ケースでの評価テスト`` () =
    ...
    let now = DateTime.UtcNow
    let tasks = [
        { TaskId = "task1"; Title = "Task 1"; Description = ""; Status = TaskStatus.Completed; AssignedAgent = None; Priority = TaskPriority.Critical; EstimatedDuration = None; ActualDuration = None; RequiredResources = []; CreatedAt = now; UpdatedAt = now }
        { TaskId = "task2"; Title = "Task 2"; Description = ""; Status = TaskStatus.Completed; AssignedAgent = None; Priority = TaskPriority.Critical; EstimatedDuration = None; ActualDuration = None; RequiredResources = []; CreatedAt = now; UpdatedAt = now }
        { TaskId = "task3"; Title = "Task 3"; Description = ""; Status = TaskStatus.Completed; AssignedAgent = None; Priority = TaskPriority.Critical; EstimatedDuration = None; ActualDuration = None; RequiredResources = []; CreatedAt = now; UpdatedAt = now }
    ]
...
let ``CompletionAssessmentManager - 品質閾値境界値テスト`` () =
    ...
    let now = DateTime.UtcNow
    let tasks = [
        { TaskId = "task1"; Title = "Task 1"; Description = ""; Status = TaskStatus.Completed; AssignedAgent = None; Priority = TaskPriority.High; EstimatedDuration = None; ActualDuration = None; RequiredResources = []; CreatedAt = now; UpdatedAt = now } // High=0.90
        { TaskId = "task2"; Title = "Task 2"; Description = ""; Status = TaskStatus.Completed; AssignedAgent = None; Priority = TaskPriority.Medium; EstimatedDuration = None; ActualDuration = None; RequiredResources = []; CreatedAt = now; UpdatedAt = now } // Medium=0.75
    ]
