            ...
            try
                ...
                if config.CreateBackup then
                    ...
                    | Some backupPath ->
                        try
                            let sourceDbPath =
                                config.SourceConnectionString.Replace("Data Source=", "").Replace(";", "")
                    ...
                    | None -> logWarning "TaskStorageMigrator" "Backup requested but no backup path provided"
    ...
    member _.ValidateMigration(sourceConnectionString: string, targetConnectionString: string) =
        async {
            try
                ...
                let sourceDbPath =
                    sourceConnectionString.Replace("Data Source=", "").Replace(";", "")

                let targetDbPath =
                    targetConnectionString.Replace("Data Source=", "").Replace(";", "")
