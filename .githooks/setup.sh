...
echo ""
echo -e "${BLUE}🚨 --no-verify protection:${NC}"
echo "  prepare-commit-msg hook will ERROR if --no-verify is used"
echo "  developers MUST fix all quality issues before committing"
echo ""
